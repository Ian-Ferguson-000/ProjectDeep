...
3. Before the boss, the player sees the first Extract/Descend choice except if attempting to extract, they find that they are lost in the forest with no idea how to return. This seals their fate.
4. The tutorial concludes in victory or death, but most likely death.
5. The player assumes ownership of the tavern:
   ...
   - **On victory:** the old keeper has gone bankrupt and offers the tavern in exchange for the boss haul leaving the adventurer as the new tavern keeper.
