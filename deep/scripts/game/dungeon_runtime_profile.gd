...
const PROFILES:Dictionary={
	...
	"crypt":{"theme":"ossuary","underlay":"090811","strategy_tint":"c8c3dc","hazards":["bone_spikes","soulflame","curse_sigils"],"slasher_enemies":["skeletal_archer","grave_acolyte","soul_wisp","skeleton"],"boss":"crypt_boss"},
