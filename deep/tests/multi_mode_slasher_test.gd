...
func _run() -> void:
	...
	var input_tuning:Dictionary=GameBalance.get_slasher_balance("input");_expect(is_equal_approx(float(input_tuning.get("held_basic_cooldown_multiplier",0.0)),2.25),"Held basic cooldown multiplier is incorrect",failures)
...
func _ensure_slasher_actions()->void:
	for action in ["character_menu","cycle_party","slasher_up","slasher_down","slasher_left","slasher_right","slasher_aim_left","slasher_aim_right","slasher_aim_up","slasher_aim_down","slasher_controller_basic","slasher_mobility","slasher_special","slasher_defend","slasher_potion","slasher_consumable_1","slasher_consumable_2","slasher_consumable_3","slasher_consumable_4"]:
